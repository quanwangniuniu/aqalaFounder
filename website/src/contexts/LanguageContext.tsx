...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    "landing.quran": "Quran",
    "landing.quranReflect": "Read & reflect",
    "landing.openQuran": "Open the Quran with Arabic and translation",
    ...
    "landing.valuePropDesc": "Listen to khutbas and lectures with real-time translation across languages. Quran verses, tafsir, and AI summaries — from any language to any language.",
  ...
  ar: {
    ...
    "landing.quran": "القرآن",
    "landing.quranReflect": "اقرأ وتدبر",
    "landing.openQuran": "افتح القرآن مع العربية والترجمة",
    "landing.donate": "تبرع",
    ...
    "landing.valuePropDesc": "استمع إلى الخطب والمحاضرات مع ترجمة فورية عبر اللغات. آيات القرآن والتفاسير وملخصات الذكاء الاصطناعي — من أي لغة إلى أي لغة.",
