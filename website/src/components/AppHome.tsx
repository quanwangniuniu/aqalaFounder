        ...
        <header className="w-full px-4 pt-4 pb-2">
          <div className="max-w-[554px] mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/app/about"
                className="hero-fade-in px-3 py-2 rounded-full text-sm font-medium text-white/80 hover:text-white hover:bg-white/5 transition-all"
              >
                {t("landing.about")}
              </Link>
              {user && (
                ...
                user ? (
                  ...
                  >
                    ...
                    <div className="pr-1">
                      ...
                      {isPremium && <p className="text-[10px] text-[#D4AF37]">Premium ✨</p>}
                    </div>
                  </Link>
                ) : (
                  <Link
                    href="/auth/login"
                    className="hero-fade-in flex items-center gap-2 px-4 py-2.5 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#b8944d] text-[#032117] font-medium text-sm hover:shadow-lg hover:shadow-[#D4AF37]/20 transition-all"
                  >
                    Sign In
                  </Link>
                )
        ...
        <main className="flex-1 flex flex-col px-4 pb-6">
          <div className="max-w-[554px] mx-auto w-full flex-1 flex flex-col">
            ...
            <section className="hero-fade-in hero-fade-in-delay-2 mt-4 grid grid-cols-2 gap-3">
              <AdLink href="/prayers" className="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-4 hover:bg-white/10 hover:border-[#D4AF37]/20 transition-all">
              ...
              <AdLink href="/qibla" className="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-4 hover:bg-white/10 hover:border-[#D4AF37]/20 transition-all">
                <div className="absolute top-0 right-0 w-20 h-20 bg-[#D4AF37]/5 rounded-full blur-2xl translate-x-1/2 -translate-y-1/2 group-hover:bg-[#D4AF37]/10 transition-colors" />
                <div className="relative">
                  <div className="w-10 h-10 rounded-xl bg-[#D4AF37]/10 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="2">
              ...
              {showAds && user ? (
                <Link href="/subscription" className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/5 backdrop-blur-md border border-[#D4AF37]/20 p-4 hover:from-[#D4AF37]/15 hover:to-[#D4AF37]/10 hover:border-[#D4AF37]/30 transition-all">
                ...
                <Link href="/donate" className="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-4 hover:bg-white/10 hover:border-[#D4AF37]/20 transition-all">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-[#D4AF37]/5 rounded-full blur-2xl translate-x-1/2 -translate-y-1/2 group-hover:bg-[#D4AF37]/10 transition-colors" />
                  <div className="relative">
                    <div className="w-10 h-10 rounded-xl bg-[#D4AF37]/10 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform">
            ...
            <section className="hero-fade-in hero-fade-in-delay-3 pt-8">
              ...
              <div className="flex items-center justify-center gap-4">
                <Link href="/reviews" className="text-xs text-white/40 hover:text-white/60 transition-colors flex items-center gap-1.5">
