    ...
    <>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm text-gray-500 mb-2">Category: Deen</p>
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Deen</h1>
        </div>
      </section>

      {/* Article grid - Muslim Pro Deen category style (with author) */}
