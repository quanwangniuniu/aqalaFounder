...
export default function QuranFeaturePage() {
  return (
    <>
      <MuslimProAppBar />
        ...
        <section className="pt-12 md:pt-20 pb-12 md:pb-20">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/75 text-base md:text-lg leading-relaxed mb-8">
              Read and reflect with Arabic and translation side by side. Explore the Quran with verse-by-verse
              understanding, tafsir, and links to trusted sources. Let Aqala guide you deeper into the Book.
            </p>
            <Link
              href="/app/quran"
