...
export default function PrayerTimesFeaturePage() {
  return (
    <>
      <MuslimProAppBar />
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-8 md:gap-12 lg:gap-14">
              <div className="flex-1 min-w-0 max-w-3xl">
                ...
                <p className="text-white/75 text-base md:text-lg lg:text-xl mb-6 leading-relaxed">
                  Stay on time with accurate prayer times and real-time Adhan alerts. Aqala uses your location to deliver
                  precise Salat timings so you never miss a prayer.
                </p>
                <p className="text-white/75 text-base md:text-lg lg:text-xl mb-8 leading-relaxed">
                  Track your prayer progress daily, explore the Islamic (Hijri) calendar, and stay grounded in salah and
                  understanding — built alongside listening and translation so your day stays connected to the Deen.
                </p>
