...
/**
 * Muslim Pro Home - /muslimpro-demo
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Explore Muslim Pro</h2>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/muslimpro-demo/features" className="px-6 py-3 rounded-full bg-[#00a651] text-white font-semibold hover:bg-[#008f44]">
              Features
            </Link>
            <Link href="/muslimpro-demo/prayer-times" className="px-6 py-3 rounded-full bg-[#00a651] text-white font-semibold hover:bg-[#008f44]">
              Prayer Times
            </Link>
            <Link href="/muslimpro-demo/quran" className="px-6 py-3 rounded-full bg-[#00a651] text-white font-semibold hover:bg-[#008f44]">
              Quran
            </Link>
            <Link href="/muslimpro-demo/blog" className="px-6 py-3 rounded-full bg-[#00a651] text-white font-semibold hover:bg-[#008f44]">
              Blog
            </Link>
            <Link href="/muslimpro-demo/about" className="px-6 py-3 rounded-full bg-[#00a651] text-white font-semibold hover:bg-[#008f44]">
              About Us
            </Link>
          </div>
        </div>
