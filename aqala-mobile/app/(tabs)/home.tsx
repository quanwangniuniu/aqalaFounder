                  ...
                  <Link href={`/user/${user.uid}`} asChild>
                    <TouchableOpacity className="flex-row items-center gap-2 px-2 py-1.5 rounded-full bg-white/5 border border-white/10">
                      ...
                      <View className="pr-1">
                        ...
                        {isPremium && (
                          <Text className="text-[10px] text-[#D4AF37]">
                            Premium ✨
                          </Text>
                        )}
                      </View>
          ...
          >
            ...
            <View className="mt-4 flex-row flex-wrap gap-3">
              ...
              >
                <View className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  ...
                  <Text className="text-xs text-white/50 mb-0.5">
                    Prayer Times
                  </Text>
                  {!prayerLoading && nextPrayer ? (
                    <>
                      <Text className="text-lg font-semibold text-white leading-tight">
                        {nextPrayer.name}
                      </Text>
                      <Text className="text-xs text-[#D4AF37]/80">
                ...
                <Link href="/subscription" asChild>
                  ...
                  >
                    <View className="rounded-2xl bg-[#D4AF37]/5 border border-[#D4AF37]/20 p-4">
                      ...
                      <Text className="text-xs text-[#D4AF37]/70 mb-0.5">
                        Go Premium
                      </Text>
                      <Text className="text-sm font-medium text-white">
                        Remove Ads
            ...
            <View className="pt-8">
              ...
              <View className="flex-row items-center justify-center gap-4">
                ...
                <Text className="text-xs text-white/30">
                  {isPremium
                    ? "Thank you for supporting Aqala ✨"
                    : t("home.freeForever")}
                </Text>
              </View>
            </View>
